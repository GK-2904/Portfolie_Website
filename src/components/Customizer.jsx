...
import { Settings, X, Save, RotateCcw, Download, Image, User, Briefcase, FileCode, Check } from 'lucide-react';
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex justify-end bg-black/60 backdrop-blur-xs transition-opacity duration-300">
          <div className="w-full max-w-lg h-full bg-white dark:bg-navy-950 shadow-2xl flex flex-col border-l border-gray-200 dark:border-navy-900 transition-transform duration-300 transform translate-x-0 relative">
            ...
            {/* Navigation Tabs */}
            <div className="flex border-b border-gray-100 dark:border-navy-900 bg-gray-50 dark:bg-navy-900/50">
              <button
                onClick={() => setActiveTab('profile')}
                className={`flex-1 py-3 text-xs sm:text-sm font-bold flex items-center justify-center gap-1.5 border-b-2 transition-colors ${
                  activeTab === 'profile'
            ...
            <div className="flex-grow overflow-y-auto p-6 space-y-6">
              ...
              {activeTab === 'activities' && (
                <div className="space-y-6">
                  <h4 className="text-sm font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-2">9 Training Activities Images</h4>
                  
                  {tempData.activities.map((act, index) => (
                    <div key={act.id} className="p-4 bg-gray-50 dark:bg-navy-900/40 rounded-xl border border-gray-150 dark:border-navy-900/60 space-y-3">
              ...
              {activeTab === 'gallery' && (
                <div className="space-y-6">
                  <h4 className="text-sm font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-2">6 Media Gallery Photos</h4>
                  
                  {tempData.galleryItems.map((item, index) => (
                    <div key={item.id} className="p-4 bg-gray-50 dark:bg-navy-900/40 rounded-xl border border-gray-150 dark:border-navy-900/60 space-y-3">
                      <div className="flex justify-between items-center">
              ...
              {activeTab === 'export' && (
                <div className="space-y-6 flex flex-col justify-center h-64 text-center">
                  ...
                  <div className="flex flex-col gap-3 max-w-xs mx-auto w-full pt-4">
                    ...
                    <button
                      onClick={handleReset}
                      className="px-4 py-3 bg-red-50 hover:bg-red-100 dark:bg-red-950/20 text-red-600 dark:text-red-400 font-bold text-sm rounded-xl flex items-center justify-center gap-2 border border-red-200/50 dark:border-red-900/30 transition-all duration-200"
                    >
